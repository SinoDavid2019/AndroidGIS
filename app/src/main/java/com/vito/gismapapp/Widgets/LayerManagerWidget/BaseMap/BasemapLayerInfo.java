package com.vito.gismapapp.Widgets.LayerManagerWidget.BaseMap;
...
public class BasemapLayerInfo {
    ...
    public static String LAYER_TYPE_TIANDITU_MAP="TianDiTuLayerMap";//天地图底图
    public static String LAYER_TYPE_TIANDITU_IMAGE="TianDiTuLayerImage";//天地图影像
    public static String LAYER_TYPE_TIANDITU_IMAGE_LABEL="TianDiTuLayerImageLabel";//天地图影像标注图层
