package com.vito.gismapapp.Map.Location;
...
import com.vito.gismapapp.Utils.DialogUtils;
...
public class DMUserLocationManager {
     ...
     * 位置采集监听事件
     */
    private PointCollection polylinePoints=new PointCollection(SpatialReferences.getWgs84());
