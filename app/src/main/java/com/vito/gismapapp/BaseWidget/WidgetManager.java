package com.vito.gismapapp.BaseWidget;
...
public class WidgetManager {
    ...
    public WidgetManager(Context context, ResourceConfig resourceConfig, MapManager mMapManager, ConfigEntity mConfigEntity) {
